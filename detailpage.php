  ...
  <body>
    ...
    <main>
      <!-- shoe name -->
          ...
          <div class="row">
            <div class="column">
              <img src="Image/dior1.png" alt="Diorshoe" style="width:100%" onclick="myFunction(this);">
            </div>
            <div class="column">
              <img src="Image/dior2.png" alt="Diorshoe" style="width:100%" onclick="myFunction(this);">
            </div>
            <div class="column">
              <img src="Image/dior3.png" alt="Diorshoe" style="width:100%" onclick="myFunction(this);">
            </div>
          ...
          <center> <h2>Close-Up Look At The Dior x Air Jordan 1 High</h2> </center>

          <img src="Image/dior7.png" style="width:100%">
    ...
    <aside id="right">
      ...
      <h1 id = "2" class = "product-name"> Jordan X Dior</h1>
      <h1 id = "3" class = "product-price"> $13427 </h1>
      <img src="Image/dior1.png" alt="Diorshoe" style=" display: none; width:30%" class="product-img">
      </div>
